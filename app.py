...
bosses = [
    ...
    {"name":"巨大鱷魚","tags":["43","44","巨鱷","鱷魚"],"respawn":180},
    {"name":"巨大蜈蚣","tags":["05","5","巨型蠕蟲","海底","海蟲","蜈蚣","蟲"],"respawn":120},
    {"name":"變形怪首領","tags":["變","變型怪","變形怪","變怪"],"respawn":420},
    {"name":"強盜頭目","tags":["27","28","強盜"],"respawn":180},
    {"name":"小綠","tags":["46","47","G","g","綠","綠王"],"respawn":120},
    {"name":"小紅","tags":["R","r","紅","紅王"],"respawn":120},
    {"name":"蜘蛛","tags":["34","35","拉亞"],"respawn":240},
    {"name":"樹精","tags":["191","20","491","樹"],"respawn":180},
    {"name":"四色","tags":["4C","4c","4色","67","68"],"respawn":120},
    {"name":"死亡騎士","tags":["04","死騎"],"respawn":540},
    {"name":"力卡溫","tags":["力卡溫","狼","狼王","郎","郎王"],"respawn":480},
    {"name":"卡司特","tags":["21","22","卡","卡王"],"respawn":450},
    ...
    {"name":"賽尼斯","tags":["304","賽"],"respawn":180},
    {"name":"烏克庫斯(19王)","tags":["19"],"respawn":360},
    {"name":"奈克偌斯(49王)","tags":["49"],"respawn":240},
...
def show_table():
    ...
    sorted_list = sorted(spawn_list, key=lambda x: x["time"])
    now = datetime.now()

    lines = ["出王時間表："]
    for b in sorted_list:
        diff = int((b["time"] - now).total_seconds() / 60)
        ...
        lines.append(f"{b['time'].strftime('%H:%M:%S')} {b['name']}{note_text}（{status}）")
